    ...
    if (rawRecords.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center h-full text-white/50">
                ...
                <p>No data available for analysis. Upload generic or specific CSV files.</p>
            </div>
        );
    }
    ...
    return (
        <div className="h-full overflow-y-auto p-6 space-y-6 custom-scrollbar pb-24">
            <header className="flex justify-between items-end border-b border-white/10 pb-4">
                <div>
                    <h1 className="text-2xl font-mono uppercase tracking-widest text-white">Multivariate Analysis</h1>
                    <p className="text-xs text-white/50 font-mono mt-1">
                        Correlate Biometric, Demographic, and Enrolment trends across {data.length} districts.
                    </p>
                </div>
            </header>
